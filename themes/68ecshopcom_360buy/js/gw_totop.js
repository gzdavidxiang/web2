$(document).ready(function() {
    ...
    */
    //console.log('os_0:', os_0, 'os_1:', os_1, 'os_2:', os_2);
    ...
    var delta = 100;
		if(scroll_h>os_0-delta){/*console.log('os_0 active');*/$(".abs_ul li").eq(0).addClass("abs_active").siblings().removeClass("abs_active");}
		if(scroll_h>os_1-delta){/*console.log('os_1 active');*/$(".abs_ul li").eq(1).addClass("abs_active").siblings().removeClass("abs_active");}
		if(scroll_h>os_2-delta){/*console.log('os_2 active');*/$(".abs_ul li").eq(2).addClass("abs_active").siblings().removeClass("abs_active");}
    /*
  ...
  $("#a-pinglun").click(function () {
	  $('html,body').animate({ scrollTop: os_2-40 }, 300);
